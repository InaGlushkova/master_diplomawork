export const elements = {
    ...
    cartBtn: document.querySelector('.addToCart__btn'),
    cartField: document.querySelector('.cart__field'),
    cart: document.querySelector('.cart__page'),
    img: document.querySelector('.cart__img'),
    buySummary: document.querySelector('.buy__summary'),
    summary: document.querySelector('.summary'),
    home: document.querySelector('.header__logo'),
    results: document.querySelector('.results'),
    recipe: document.querySelector('.recipe'),
    cartPage: document.querySelector('.product__list'),
    cartImg: document.querySelector('.product__img'),
    shoppingList: document.querySelector('.shopping'),
    container: document.querySelector('.container'),
    buy: document.querySelector('.buy__btn'),
    checkout: document.querySelector('.cart__checkout'),
    checkoutBtn: document.querySelector('.checkout__btn'),
    thankyouPage: document.querySelector('.thankyou__page'),
    form: document.querySelector('.checkout__form'),
